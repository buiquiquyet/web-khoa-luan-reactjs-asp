...
const basicRouter = [
    ...
    {path: '/admin', component: HomeAdmin, layout: DefaultLayoutAdmin, type: 'admin'},
    {path: '/AdminCreateEditUser', component: AdminCreateEditUser,layout: DefaultLayoutAdmin, type: 'AdminCreateUser'},
    {path: '/AdminCreateEditUser/:idUser', component: AdminCreateEditUser,layout: DefaultLayoutAdmin, type: 'AdminEditUser'},
    
    {path: '/adminForum', component: AdminForum, layout: DefaultLayoutAdmin, type: 'adminForum'},
    {path: '/AdminCreateEditForum', component: AdminCreateEditForum,layout: DefaultLayoutAdmin, type: 'AdminCreateForum'},
    {path: '/AdminCreateEditForum/:idForum', component: AdminCreateEditForum,layout: DefaultLayoutAdmin, type: 'AdminEditForum'},
    {path: '/adminDuyet', component: AdminProjectListCheck, layout: DefaultLayoutAdmin, type: 'adminDuyet'},

]
const loggedInRoutes = isLoggedIn && checkUserGroup
    ? [
        {
